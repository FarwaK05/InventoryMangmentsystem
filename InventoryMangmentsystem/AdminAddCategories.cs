...
namespace InventoryMangmentsystem
{
    ...
    {
        SqlConnection
        connect = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\ztech.pk\Documents\inventory.mdf;Integrated Security=True;Connect Timeout=30");
